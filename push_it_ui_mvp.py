...
class PushItUI(QMainWindow):
    ...
    def _build_form(self, parent_layout):
        ...
        """Display Skippy help image in a popup dialog, with fallback file picker if missing."""
        # Determine default image path
        script_dir = os.path.dirname(__file__)
        default_name = "a82ae152-5072-424e-a6cd-3f578d28dada.png"
        img_path = os.path.join(script_dir, default_name)
